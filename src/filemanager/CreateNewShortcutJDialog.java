...
public class CreateNewShortcutJDialog extends JDialog {
    
    /**
     *
     */
    private static final long serialVersionUID = 5895138231231590638L;
    ...
    private JLabel newFolderWait = new JLabel("Имя ярлыка : ");
    private boolean ready = false;

    public CreateNewShortcutJDialog(JFrame jframe) {
        
        super(jframe, "Создать новый ярлык", true);
