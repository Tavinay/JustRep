...
public class CopyJDialog extends JDialog {
    
    /**
     *
     */
    private static final long serialVersionUID = 4159374278314986494L;
    ...
    private JLabel newFolderWait = new JLabel("Путь копирования : ");
    private boolean ready = false;

    public CopyJDialog(JFrame jframe){ 
